...
const handleEdit = (photo) => {
 ...
 // console.log('isManageOpen : ', isManageOpen)
    ...
    <header className="flex items-center justify-between px-6 py-4 text-white bg-gray-800 shadow-md">
      <div className="mr-64 text-2xl font-bold animate-wave">Hannah PhotoGallery</div> 
        ...
        <div>
         ...
         <div style={{ display: "flex", gap: "10px" }}> 
          ...
          <div style={styles.menuItem}> 
              <button style={{ ...styles.menuButton, ...(isManageOpen ? styles.activeButton : {}), }}
        ...
        {isManageOpen && ( 
          ...
          {editingPhoto &&  (
            <div style={{ ...styles.modal, top: "120px", width: "500px", left: "30%", transform: "translatX(-70%", position:"absolute"}}>
              <div style={styles.modalContent}>
        ...
        {username ? (
          <>
            ...
            <button
              ...
              className="px-4 py-2 ml-3 font-semibold text-white bg-red-500 rounded-lg hover:bg-red-600"
            >
              Logout
            </button>
          </>
